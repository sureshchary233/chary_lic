      ...
      <div className="pos">
        <header>
          ...
          <p>
            <div className="social">
              <a
                href="https://www.facebook.com/share/hyLFKtA9uPjCxSsu/?mibextid=qi2Omg"
                target="_blank"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/charyliccharys?igsh=MWRmYml4a2dlZzBrZg=="
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                href="https://maps.app.goo.gl/g1wLctWyC7tVr1jH7s"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="9848534959" target="_blank">
                <svg
                  height="35px"
                  id="Layer_1"
        ...
        <div className="pic">
          <img
            ...
            src="https://media.discordapp.net/attachments/1234829933470023723/1234831858240589834/WhatsApp_Image_2024-04-25_at_2.29.00_PM.jpeg?ex=66322a49&is=6630d8c9&hm=9c5351f05851b9c8915b468a855bb22dbb9d1fb92b88146bb1e5011b9e1e6a7a&=&format=webp&width=253&height=563"
          />
        </div>
      </div>
      <div>
        <div className="image-container">
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234830063778791485/WhatsApp_Image_2024-04-23_at_10.48.02_PM.jpeg?ex=6632289d&is=6630d71d&hm=296e9e94872072572d262b6d229622ef1959a45068b45f9cdaf9b71321014c9a&=&format=webp&width=386&height=565"
            alt="Image 1"
          />
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234830500498112532/WhatsApp_Image_2024-04-23_at_10.48.20_PM_1.jpeg?ex=66322905&is=6630d785&hm=e92cd0aa056468c42846501c9c61503c1d53d6b5c96b56362497c984a2babb07&=&format=webp&width=392&height=565"
            alt="Image 2"
          />
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234830792333463633/WhatsApp_Image_2024-04-23_at_10.48.19_PM.jpeg?ex=6632294a&is=6630d7ca&hm=22f47a3d1ca7628f7fc7720c0546bbdacd97bdf75be80078bc8d10f3869b1a3e&=&format=webp&width=423&height=565"
            alt="Image 3"
          />
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234831022949007390/WhatsApp_Image_2024-04-23_at_10.48.28_PM.jpeg?ex=66322981&is=6630d801&hm=e9fd0f6cc5dd39acb94196d4452af5571ddc892af578c7372cde73747e62c3a5&=&format=webp&width=458&height=565"
            alt="Image 4"
          />
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234831298955186176/WhatsApp_Image_2024-04-23_at_10.48.20_PM.jpeg?ex=663229c3&is=6630d843&hm=3d0b63277d7b0cade7d743da1531aafb821b09d9837537c4c34c7993f98455a6&=&format=webp&width=565&height=565"
            alt="Image 5"
          />
          <img
            src="https://media.discordapp.net/attachments/1234829933470023723/1234831690564632576/WhatsApp_Image_2024-04-23_at_10.48.18_PM.jpeg?ex=66322a21&is=6630d8a1&hm=df27fe344d28bc2a7b67d70413d3d47624a8af7468de1fb96e018936f980447b&=&format=webp&width=565&height=565"
            alt="Image 6"
          />
        </div>
      </div>
      <div class="container">
        <div class="left">
          ...
          <h2>
            <p>. LIC Chary</p>
            <p>. 9848534959</p>
            <p>. charylicc@gmail.com</p>
          </h2>
        </div>

        <title>Registration Form</title>

        <form action="https://formspree.io/f/mgegrblq" method="POST">
          ...
          <div class="form-group">
            <label for="message-code">Message Code:</label>
            <input type="text" id="message-code" name="message-code" required />
          </div>
